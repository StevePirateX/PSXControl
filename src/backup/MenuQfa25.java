...
public class MenuQfa25 extends CduMenu {
	...
	public static void showMenu() {
		...
		send("Qs77=" + qs77Menu + getLine(1));
		motionFreeze(getLine(2));
		send("Qs79=" + qs79Menu + getLine(3));
		send("Qs80=" + qs80Menu + getLine(4));
		send("Qs81=" + qs81Menu + getLine(5));
		send("Qs82=" + qs82Menu + getLine(6));
